    ...
    :cowboy_router.compile([
      ...
      { :_,
        ...
        [
          ...
          {"/", :cowboy_static, {:priv_file, :service_client, "dist/index.html"}},
          ...
          {"/websocket_demo/[...]", :cowboy_static, {:priv_dir,  :service_client, "websocket_demo/"}},
          ...
          {"/[...]", :cowboy_static, {:priv_dir,  :service_client, "dist/"}},
      ]}
    ])
  end
end
